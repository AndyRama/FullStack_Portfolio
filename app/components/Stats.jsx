            ...
            <div className="bg-light py-10 lg:px-8 md:pr-32 rounded-lg relative">
              ...
              {statContent.getStarted.cta.cta_label && (
                <Link
                  ...
                  target="_blank"
                  className="block text-center text-[11.5px] tracking-[2px] font-bold uppercase  bg-gradient-to-r from-green-300 to-green-500 py-4 px-5 text-white rounded-md hover:shadow-2xl "
                >
