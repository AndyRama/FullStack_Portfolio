...
const iconMappingProject = {
  ...
  icon2: (
    <TbBrandNextjs className="mt-1 mr-1 rounded-sm text-black-300 border border-gray-200 bg-opacity-10" />
  ),
  icon3: (
    <LuWrench className="mt-1 mr-1 rounded-sm text-black-300 border border-gray-200 bg-opacity-10" />
  ),
  icon4: (
    <HiOutlineTerminal className="mt-1 mr-1 rounded-sm text-black-300 border border-gray-200 bg-opacity-10" />
  ),
  icon5: (
    <FaShop className="mt-1 mr-1 rounded-sm text-black-300 border border-gray-200 bg-opacity-10" />
  ),
  icon6: (
    <HiOutlineTemplate className="mt-1 mr-1 rounded-sm text-black-300 border border-gray-200 bg-opacity-10" />
  ),
}
