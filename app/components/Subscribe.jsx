  ...
  return (
    <section className={`${className}`}>
        ...
        <div className="flex flex-col mx-auto justify-center">
          ...
          <div className="flex flex-col mx-auto justify-center mt-10">
            <Link
              ...
              bg-gradient-to-r from-red-400 to-red-600  py-4 px-5 rounded hover:text-white hover:bg-white
      ...
      <div className="transform-gpu blur-3xl">
        <div className="absolute right-0 bottom-60 opacity-50 -z-50 w-32 h-48 md:w-52 md:h-64 bg-gradient-to-tr from-red-400 to-red-600 "></div>
      </div>
    </section>
  )
}
