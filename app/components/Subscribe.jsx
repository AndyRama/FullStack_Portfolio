  ...
  return (
    <section className={`${className}`}>
        ...
        <div className="flex flex-col mx-auto justify-center">
          ...
          <div className="flex flex-col mx-auto justify-center mt-10">
            <Link
              ...
              bg-gradient-to-r from-green-300 to-green-500 py-4 px-5 rounded text-white hover:bg-white
              hover:shadow-2xl mb-5 mr-5 inline-block w-[300px] text-center hover:text-[#2F2E2E]"
            >
      ...
      <div className="transform-gpu blur-3xl">
        <div className="absolute right-0 bottom-60 opacity-50 -z-50 w-32 h-48 md:w-52 md:h-64 bg-gradient-to-tr from-green-300 to-green-500"></div>
      </div>
    </section>
  )
}
