                ...
                >
                  <span className="text-2xl md:text-3xl flex flex-col items-center ">
                    ...
                    <h3
                      ...
                      relative before:content-[''] before:absolute before:bottom-0 before:left-0 before:w-full before:h-[2px] before:bg-gradient-to-r from-green-300
                      to-green-500  before:origin-[100%, 50%] before:transition-all before:duration-300 before:ease-in-out before:scale-x-0
